...
//   const [appointmentNote, setAppointmentNote] = useState(lead.note || "");
...
//           payload.note = appointmentNote.trim();
//         }
//       }
...
//                 <div
//                   key={index}
//                   className="bg-gray-50 p-3 rounded-xl space-y-2 border border-gray-200"
//                 >
...
//                               (sum, p, i) => i !== index ? sum + (parseFloat(p.depositUsed) || 0) : sum, 0
//                             );
//                             const available = patientBalance - usedByOthers;
...
//                 <div className="flex items-center justify-between">
//                   <div>
//                     <span className="text-sm font-medium text-red-700">นัดหมายครั้งถัดไป</span>
//                     <p className="text-xs text-red-400 mt-0.5">สร้างข้อมูลใหม่สำหรับการนัดหมายครั้งถัดไป</p>
//                   </div>
//                   <button
//                     type="button"
//                     role="switch"
